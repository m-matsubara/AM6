 ...
 * @author m.matsubara
 */
public class Op_LogicalAndExpression implements IParsedExpression {
    private IParsedExpression operand1Expression;
    private IParsedExpression operand2Expression;
    private int operatorIdx;

    public Op_LogicalAndExpression(IParsedExpression operand1, IParsedExpression operand2, int operatorIdx) throws ExpException {
    ...
    /*
     *  (非 Javadoc)
     * @see com.mmatsubara.expresser.Op_LogicalAndExpression.IParsedExpression#evaluate(com.mmatsubara.expresser.RuntimeData)
     */
    public IExpObject evaluate(RuntimeData runtime) throws ExpException {
        ...
        try {
            ...
            if (typeConverter.toBoolean(runtime, operand1).booleanValue() == false)
                return new _Boolean(false);
            if (typeConverter.toBoolean(runtime, operand2).booleanValue() == false)
                return new _Boolean(false);
