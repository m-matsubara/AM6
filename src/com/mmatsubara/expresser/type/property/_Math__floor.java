...
public class _Math__floor extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("floor");
     ...
     *
     */
    private _Math__floor() throws ExpException {
        super("floor", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.floor(number));
    }
