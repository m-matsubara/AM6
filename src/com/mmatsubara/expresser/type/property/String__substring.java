...
public class String__substring extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("substring");
     ...
     *
     */
    private String__substring() throws ExpException {
        super("substring", 2);
    }
    ...
    public static IExpObject getInstance() throws ExpException {
        if (instance == null)
            instance = new String__substring();
        return instance;
    }
}
