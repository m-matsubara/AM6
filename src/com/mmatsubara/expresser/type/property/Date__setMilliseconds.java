...
public class Date__setMilliseconds extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("setMilliseconds");
     ...
     *
     */
    private Date__setMilliseconds() throws ExpException {
        super("setMilliseconds", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        try {
            if (arguments.length >= 1)
                milliseconds = ((ExpNumberBase)(arguments[0])).intValue();
        } catch (ClassCastException cce) {
            milliseconds = runtime.getTypeConverter().toNumber(runtime, arguments[0]).intValue();
        }
    ...
    public static IExpObject getInstance() throws ExpException {
        if (instance == null)
            instance = new Date__setMilliseconds();
        return instance;
    }
    ...
    public static IExpObject getInstance(TimeZone timeZone) throws ExpException {
        Date__setMilliseconds instance = new Date__setMilliseconds();
