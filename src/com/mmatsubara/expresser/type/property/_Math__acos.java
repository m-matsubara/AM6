...
public class _Math__acos extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("acos");
     ...
     *
     */
    private _Math__acos() throws ExpException {
        super("acos", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.acos(number));
    }
