...
public class _Math__asin extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("asin");
     ...
     *
     */
    private _Math__asin() throws ExpException {
        super("asin", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.asin(number));
    }
