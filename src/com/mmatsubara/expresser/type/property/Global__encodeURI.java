...
public class Global__encodeURI extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("encodeURI");
     ...
     *
     */
    private Global__encodeURI() throws ExpException {
        super("encodeURI", 1);
    }
    ...
    public static IExpObject getInstance() throws ExpException {
        if (instance == null)
            instance = new Global__encodeURI();
        return instance;
    }
