...
/**
 * String型の lastIndexOf() メソッドです。<br/>
 * <br/>
 * 作成日: 2005/04/03
 * 
 * @author m.matsubara
...
public class String__lastIndexOf extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("lastIndexOf");
     ...
     *
     */
    private String__lastIndexOf() throws ExpException {
        super("lastIndexOf", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        //  演算
        int result = value.lastIndexOf(key, from);
    ...
    public static IExpObject getInstance() throws ExpException {
        if (instance == null)
            instance = new String__lastIndexOf();
        return instance;
    }
}
