...
public class Global__writeln extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("writeln");
     ...
     *
     */
    private Global__writeln() throws ExpException {
        super("writeln", 1);
    }
