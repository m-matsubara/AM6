...
public class _Math__ceil extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("ceil");
     ...
     *
     */
    private _Math__ceil() throws ExpException {
        super("ceil", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.ceil(number));
    }
