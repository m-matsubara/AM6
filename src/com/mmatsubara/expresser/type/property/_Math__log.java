...
public class _Math__log extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("log");
     ...
     *
     */
    private _Math__log() throws ExpException {
        super("log", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.log(number));
    }
