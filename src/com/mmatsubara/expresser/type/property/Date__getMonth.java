...
public class Date__getMonth extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("getMonth");
     ...
     *
     */
    private Date__getMonth() throws ExpException {
        super("getMonth", 0);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(calendar.get(Calendar.MONTH));
    }
    ...
    public static IExpObject getInstance(TimeZone timeZone) throws ExpException {
        Date__getMonth instance = new Date__getMonth();
