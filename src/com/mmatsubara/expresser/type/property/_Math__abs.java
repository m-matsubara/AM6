...
public class _Math__abs extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("abs");
     ...
     *
     */
    private _Math__abs() throws ExpException {
        super("abs", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.abs(number));
    }
