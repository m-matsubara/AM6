...
public class Global__decodeURIComponent extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("decodeURIComponent");
     ...
     *
     */
    private Global__decodeURIComponent() throws ExpException {
        super("decodeURI", 1);
    }
    ...
    public static IExpObject getInstance() throws ExpException {
        if (instance == null)
            instance = new Global__decodeURIComponent();
        return instance;
    }
