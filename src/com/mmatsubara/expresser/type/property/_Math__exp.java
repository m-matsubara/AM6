...
public class _Math__exp  extends ExpFunctionBase {
    public static final Integer ID = StringToId.toId("exp");
     ...
     *
     */
    private _Math__exp() throws ExpException {
        super("exp", 1);
    }
    ...
    public IExpObject callFunction(RuntimeData runtime, IExpObject thisObject, IExpObject[] arguments)
        ...
        return new _Double(Math.exp(number));
    }
