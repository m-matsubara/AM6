 ...
 *
 */
public class _Integer extends ExpNumberBase implements IExpObject {
    private int value;
    private IExpObject _description = Expresser.UNDEFINED;	//	独自拡張
    
    private static ExpObject prototype = null;

    public _Integer(int value) throws ExpException {
        this.value = value;
        getPrototype();
    }
    ...
    public boolean equals(Object object) {
        if (object instanceof ExpNumberBase) {
            return value == ((ExpNumberBase)object).intValue();
        } else {
            return false;
        }
